...
Conclusion "You've just proved your first derived theorem! We're slowly regaining the properties we used to take for granted. In the future, you'll be able to cite `neg_add_cancel`, bundling three steps into one! You'll use this a lot in the future."

NewTheorem add_assoc
